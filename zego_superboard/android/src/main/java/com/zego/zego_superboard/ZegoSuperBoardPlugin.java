package com.zego.zego_superboard;

import androidx.annotation.NonNull;

import com.zego.zego_superboard.internal.ZegoPlatformViewFactory;
...
/** ZegoSuperBoardPlugin */
public class ZegoSuperBoardPlugin implements FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler  {
  ...
  public ZegoSuperBoardPlugin() {
    try {
      this.manager = Class.forName("com.zego.zego_superboard.internal.ZegoSuperBoardMethodHandler");
  ...
  public static void registerWith(Registrar registrar) {
    ...
    ZegoSuperBoardPlugin plugin = new ZegoSuperBoardPlugin();
